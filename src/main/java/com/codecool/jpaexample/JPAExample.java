...
public class JPAExample {
    ...
    public static void populateDb(EntityManager em) {
        ...
        phoneNumbers.add("06301231234");
        phoneNumbers.add("06701231234");
        ...
        Student student = new Student("Ödön", "odon@tokodon.hu", birthDate1, address, phoneNumbers, classBp2);
        ...
        phoneNumbers2.add("06301666234");
        phoneNumbers2.add("06701666234");
        Address address2 = new Address("Hungary", "6789", "Budapest", "Harap u. 3.");
        Student student2 = new Student("Aladár", "ktyfl@gmail.com", birthDate2, address, phoneNumbers2, classBp2);
